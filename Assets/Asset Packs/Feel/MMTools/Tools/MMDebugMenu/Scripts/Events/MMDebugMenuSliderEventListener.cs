...
public class MMDebugMenuSliderEventListener : MonoBehaviour
{
    ...
    [Header("Test")] [Range(0f, 1f)] public float TestValue = 1f;
    [MMInspectorButton("TestSetValue")] public bool TestSetValueButton;
    ...
    protected virtual void OnMMDebugMenuSliderEvent(string sliderEventName, float value,
        MMDebugMenuSliderEvent.EventModes eventMode)
    {
        ...
        {
            if (MMDValueChangedEvent != null) { MMDValueChangedEvent.Invoke(value); }
        }
    }
