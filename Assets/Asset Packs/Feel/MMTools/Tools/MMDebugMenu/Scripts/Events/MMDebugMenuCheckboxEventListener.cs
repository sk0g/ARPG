...
public class MMDebugMenuCheckboxEventListener : MonoBehaviour
{
    ...
    [Header("Test")] public bool TestValue = true;
        ...
        MMDebugMenuCheckboxEvent.EventModes eventMode)
    {
        ...
        {
            if (MMDPressedEvent != null) { MMDPressedEvent.Invoke(value); }

            if (value)
            {
                if (MMDTrueEvent != null) { MMDTrueEvent.Invoke(); }
            }
            else
            {
                if (MMDFalseEvent != null) { MMDFalseEvent.Invoke(); }
            }
        }
    }
