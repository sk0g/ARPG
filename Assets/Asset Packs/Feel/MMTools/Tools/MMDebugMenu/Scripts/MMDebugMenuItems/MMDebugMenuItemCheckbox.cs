...
public class MMDebugMenuItemCheckbox : MonoBehaviour
{
    ...
    public virtual void TriggerCheckboxEvent()
    {
        ...
        MMDebugMenuCheckboxEvent.Trigger(CheckboxEventName, Switch.SwitchState,
                                         MMDebugMenuCheckboxEvent.EventModes.FromCheckbox);
    }
    ...
    protected virtual void OnMMDebugMenuCheckboxEvent(string checkboxEventName, bool value,
        MMDebugMenuCheckboxEvent.EventModes eventMode)
    {
            ...
            && (checkboxEventName == CheckboxEventName))
        {
            ...
            if (value) { Switch.SetTrue(); }
            else { Switch.SetFalse(); }
        }
    }
