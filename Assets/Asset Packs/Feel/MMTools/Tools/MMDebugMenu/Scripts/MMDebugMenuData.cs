...
public class MMDebugMenuTabData
{
    ...
    [MMReorderableAttribute] public MMDebugMenuItemList MenuItems;
}
...
public class MMDebugMenuItem
{
    ...
    [MMHidden] public MMDebugMenuItemSlider TargetSlider;
    [MMHidden] public MMDebugMenuItemButton TargetButton;
    [MMHidden] public MMDebugMenuItemCheckbox TargetCheckbox;
}
...
{
    [Header("Prefabs")] public MMDebugMenuItemTitle TitlePrefab;
    ...
    [Header("Tabs")] public List<MMDebugMenuTabData> Tabs;
    public bool DisplayDebugTab = true;
    public int MaxTabs = 5;
    public int InitialActiveTabIndex = 0;

    [Header("Toggle")] public MMDebugMenu.ToggleDirections ToggleDirection = MMDebugMenu.ToggleDirections.RightToLeft;
    ...
    [Header("Style")] public Font RegularFont;
