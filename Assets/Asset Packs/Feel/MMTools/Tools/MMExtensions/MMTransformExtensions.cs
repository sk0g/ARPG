...
public static class TransformExtensions
{
    ...
    public static void MMDestroyAllChildren(this Transform transform)
    {
        ...
        {
            if (Application.isPlaying) { UnityEngine.Object.Destroy(transform.GetChild(t).gameObject); }
            else { UnityEngine.Object.DestroyImmediate(transform.GetChild(t).gameObject); }
        }
    }
