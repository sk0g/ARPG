...
public class PanningTexture : MonoBehaviour
{
    ...
    [Tooltip("the index of the material")] public int MaterialIndex = 0;
    ...
    protected virtual void Update()
    {
        ...
        // position reset
        if (_position.x > 1.0f) { _position.x -= 1.0f; }

        if (_position.y > 1.0f) { _position.y -= 1.0f; }
        ...
        if (_rawImage != null) { _rawImage.material.mainTextureOffset = _position; }
    }
}
}