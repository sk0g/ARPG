...
public class MMPostProcessingMovingFilter : MonoBehaviour
{
    ...
    protected virtual void Initialization()
    {
        ...
        if (AddToInitialPosition) { _initialPosition = this.transform.localPosition; }
        else { _initialPosition = Vector3.zero; }
    ...
    protected virtual void Update()
    {
        ...
        if (_lastReachedState == Active) { return; }
    ...
    {
        if (_newPosition != this.transform.localPosition) { this.transform.localPosition = _newPosition; }
    ...
    public virtual void OnMMPostProcessingMovingFilterEvent(MMTweenType curve, bool active, bool toggle, float duration,
        int channel = 0, bool stop = false)
    {
    ...
    {
        MMPostProcessingMovingFilterEvent.Trigger(new MMTweenType(MMTween.MMTweenCurve.EaseInOutCubic), false, false,
                                                  TestDuration, 0);
    }
