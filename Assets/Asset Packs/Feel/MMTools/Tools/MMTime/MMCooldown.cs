...
public class MMCooldown
{
    ...
    {
        if (Ready()) { CooldownState = CooldownStates.Consuming; }
    }
    ...
    public virtual bool Ready()
    {
        ...
        if (CooldownState == CooldownStates.Idle) { return true; }

        if ((CooldownState == CooldownStates.Refilling) && (CanInterruptRefill)) { return true; }
