...
public class MMDebugOnScreenConsole : MonoBehaviour
{
    ...
    public virtual void Toggle()
    {
        ...
        else { BackgroundImage.rectTransform.sizeDelta = _openBackgroundWidth; }
    ...
    protected virtual void LateUpdate()
    {
        ...
        if (!_newMessageThisFrame && ConsoleText.isActiveAndEnabled) { this.gameObject.SetActive(false); }
    ...
    public virtual void AddMessage(string label, object value, int fontSize)
    {
        ...
        if (_stringBuilder.Length != 0) { _stringBuilder.Append(System.Environment.NewLine); }
