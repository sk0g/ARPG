...
public class MMInputExecutionBinding
{
    ...
    public virtual void ProcessInput()
    {
        if (OnKey != null)
        {
            if (Input.GetKey(TargetKey)) { OnKey.Invoke(); }
        }

        if (OnKeyDown != null)
        {
            if (Input.GetKeyDown(TargetKey)) { OnKeyDown.Invoke(); }
        }

        if (OnKeyUp != null)
        {
            if (Input.GetKeyUp(TargetKey)) { OnKeyUp.Invoke(); }
        }
    }
}
...
public class MMInputExecution : MonoBehaviour
{
    ...
    {
        foreach (MMInputExecutionBinding binding in Bindings) { binding.ProcessInput(); }
    }
}
}