...
public class MMHealthBar : MonoBehaviour
{
    ...
    public virtual void Initialization()
    {
        ...
        if (HealthBarType == HealthBarTypes.Prefab)
        {
            ...
            _progressBar =
                Instantiate(HealthBarPrefab, transform.position + HealthBarOffset, transform.rotation) as MMProgressBar;
    ...
    protected virtual void DrawHealthBar()
    {
        ...
        if (NestDrawnHealthBar) { newGameObject.transform.SetParent(this.transform); }
    ...
    protected virtual IEnumerator FinalHideBar()
    {
        ...
        else { _progressBar.HideBar(HideBarAtZeroDelay); }
    }
