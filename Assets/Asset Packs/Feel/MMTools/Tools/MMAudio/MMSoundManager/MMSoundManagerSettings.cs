...
public class MMSoundManagerSettings
{
    ...
    [Tooltip("whether the master track is active at the moment or not")] [MMReadOnly]
    public bool MasterOn = true;

    /// the volume of the master track before it was muted
    [Tooltip("the volume of the master track before it was muted")] [MMReadOnly]
    ...
    [Tooltip("whether the music track is active at the moment or not")] [MMReadOnly]
    public bool MusicOn = true;

    /// the volume of the music track before it was muted
    [Tooltip("the volume of the music track before it was muted")] [MMReadOnly]
    ...
    [Tooltip("whether the SFX track is active at the moment or not")] [MMReadOnly]
    public bool SfxOn = true;

    /// the volume of the SFX track before it was muted
    [Tooltip("the volume of the SFX track before it was muted")] [MMReadOnly]
    ...
    [Tooltip("whether the UI track is active at the moment or not")] [MMReadOnly]
    public bool UIOn = true;

    /// the volume of the UI track before it was muted
    [Tooltip("the volume of the UI track before it was muted")] [MMReadOnly]
