...
public class MMPreventPassingThrough2D : MonoBehaviour
{
    ...
    [Header("Debug")] [MMReadOnly] public RaycastHit2D Hit;
    ...
    protected virtual void Update()
    {
        ...
        if (_lastMovementSquared > _squaredBoundsWidth)
        {
            ...
            RaycastHit2D hitInfo = MMDebug.RayCast(_positionLastFrame, _lastMovement.normalized, movementMagnitude,
                                                   ObstaclesLayerMask, Color.blue, true);
