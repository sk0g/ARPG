...
public class MMTilemapBoolean : MonoBehaviour
{
    ...
    [MMInspectorButton("BooleanClean")] public bool BooleanCleanButton;
    ...
    protected virtual void BooleanClean()
    {
        ...
        foreach (Vector3Int pos in _tilemap.cellBounds.allPositionsWithin)
        {
            ...
            {
                if (TilemapToClean.HasTile(localPlace)) { TilemapToClean.SetTile(localPlace, null); }
            }
        }
