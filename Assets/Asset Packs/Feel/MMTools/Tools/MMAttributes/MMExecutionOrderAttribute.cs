...
public class MMExecutionOrderAttribute : Attribute
{
    ...
    protected static void ModifyExecutionOrder()
    {
        ...
        if (ExecutionOrderHasChanged()) { UpdateExecutionOrders(); }
    }
    ...
    protected static void FindExecutionOrderAttributes()
    {
        ...
        {
            if (!HasExecutionOrderAttribute(assemblyType)) { continue; }
            ...
            {
                Debug.LogError("MMTools' ExecutionOrderAttribute : Can't change "
                               + assemblyType.Name
                               + "'s execution order");
                return;
            }
