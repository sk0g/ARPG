...
public class MMTilemapGenerator : MonoBehaviour
{
    ...
    public virtual void Generate()
    {
        ...
        foreach (MMTilemapGeneratorLayer layer in Layers) { GenerateLayer(layer); }
    }
    ...
    protected virtual void GenerateLayer(MMTilemapGeneratorLayer layer)
    {
        ...
        {
            Random.InitState((int) System.DateTime.Now.Ticks);
            if (layer.RandomizeSeed) { layer.Seed = Mathf.Abs(Random.Range(int.MinValue, int.MaxValue)); }
        ...
        case GenerateMethods.RandomWalkAvoider:
            ...
            _grid = MMGridGeneratorRandomWalkAvoider.Generate(width, height, seed, layer.RandomWalkAvoiderPercent,
                                                              layer.RandomWalkAvoiderStartingPoint, obstacleGrid,
                                                              layer.RandomWalkAvoiderObstaclesDistance,
                                                              layer.RandomWalkAvoiderMaxIterations);
            layer.Grid = _grid;
            break;
        case GenerateMethods.RandomWalkGround:
            _grid = MMGridGeneratorRandomWalkGround.Generate(width, height, seed,
                                                             layer.RandomWalkGroundMinHeightDifference,
                                                             layer.RandomWalkGroundMaxHeightDifference,
                                                             layer.RandomWalkGroundMinFlatDistance,
                                                             layer.RandomWalkGroundMaxFlatDistance,
                                                             layer.RandomWalkGroundMaxHeight);
            layer.Grid = _grid;
            break;
        case GenerateMethods.Path:
            _grid = MMGridGeneratorPath.Generate(width, height, seed, layer.PathDirection, layer.PathStartPosition,
                                                 layer.PathMinWidth,
                                                 layer.PathMaxWidth, layer.PathDirectionChangeDistance,
                                                 layer.PathWidthChangePercentage,
    ...
    protected virtual void OnValidate()
    {
        ...
        foreach (MMTilemapGeneratorLayer layer in Layers) { layer.SetDefaults(); }
    }
}
}