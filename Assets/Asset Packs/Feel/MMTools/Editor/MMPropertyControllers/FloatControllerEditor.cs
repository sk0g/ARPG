    ...
    public override void OnInspectorGUI()
    {
        ...
        if (myTarget.AttributeNames != null)
        {
            if (myTarget.AttributeNames.Length > 0)
            {
                ...
                {
                    "m_Script", "TargetObject", "Curve", "MinValue", "MaxValue",
                    "Duration", "Amplitude",
                    "RemapNoiseValues", "RemapNoiseZero", "RemapNoiseOne",
                    "Frequency", "Shift", "InitialValue", "CurrentValue",
                    "CurrentValueNormalized", "PingPongPauseDuration",
                    "OneTimeDuration", "OneTimeAmplitude", "OneTimeRemapMin",
                    "OneTimeRemapMax",
                    ...
                    "ToDestinationDuration", "ToDestinationValue", "ToDestinationCurve",
                    "ToDestinationButton"
                });
                ...
                else if (myTarget.ControlMode == FloatController.ControlModes.AudioAnalyzer)
                {
                    ...
                    else { EditorGUILayout.PropertyField(_NormalizedLevelID); }
