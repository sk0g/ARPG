...
public class ShaderControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            "m_Script", "Curve", "MinValue", "MaxValue", "Duration",
            "PingPongPauseDuration",
            "Amplitude", "Frequency", "Shift", "OneTimeDuration", "OneTimeAmplitude",
            "OneTimeRemapMin",
            "OneTimeRemapMax", "OneTimeCurve", "DisableAfterOneTime",
            "DisableGameObjectAfterOneTime", "OneTimeButton", "AudioAnalyzer",
            "BeatID", "AudioAnalyzerMultiplier", "AudioAnalyzerOffset",
            "AudioAnalyzerLerp", "ToDestinationValue", "RemapNoiseValues",
            "RemapNoiseZero", "RemapNoiseOne",
            "ToDestinationDuration", "ToDestinationCurve", "DisableAfterToDestination",
            "ToDestinationButton", "DrivenLevel", "FromColor", "ToColor",
            "InitialValue", "CurrentValue", "CurrentValueNormalized", "InitialColor",
            "PropertyID", "PropertyFound", "TargetMaterial"
        });
