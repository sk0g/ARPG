...
public class MMSoundManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (((_settingsSO != null) && _mmSoundManager.gameObject.activeInHierarchy))
        {
            DrawTrack("Master Track", MMSoundManager.Instance.settingsSo.Settings.MasterOn,
                      MMSoundManager.MMSoundManagerTracks.Master, _masterColorMute, _masterColorUnmute,
                      _masterColorPause, _masterColorStop, _masterColorPlay, _masterColorFree);
    ...
    public void DrawColoredButton(string buttonLabel, Color buttonColor, MMSoundManager.MMSoundManagerTracks track,
        System.Action<MMSoundManager.MMSoundManagerTracks> action, GUIStyle styles)
    {
