...
public class WobbleButton : MonoBehaviour, IPointerExitHandler, IPointerEnterHandler
{
    ...
    [Header("Haptics")] public TextAsset AHAPFile;
    ...
    protected virtual Vector3 GetWorldPosition(Vector3 testPosition)
    {
        ...
        {
            RectTransformUtility.ScreenPointToLocalPointInRectangle(_canvas.transform as RectTransform, testPosition,
                                                                    _canvas.worldCamera, out _workPosition);
            return _canvas.transform.TransformPoint(_workPosition);
        }
        else { return testPosition; }
    }
    ...
    public virtual void OnPointerExit(PointerEventData data)
    {
        ...
        MMVibrationManager.AdvancedHapticPattern(AHAPFile.text, _wobbleAndroidPattern, _wobbleAndroidAmplitude, -1,
                                                 _wobbleAndroidPattern, _wobbleAndroidAmplitude,
                                                 _wobbleAndroidAmplitude, -1, HapticTypes.LightImpact,
                                                 this);
    }
