...
public class MMVibrationManagerTester : MonoBehaviour
{
    ...
    [Header("Haptics")] public HapticMethods HapticMethod = HapticMethods.NativePreset;
    ...
    [Header("Rumble")] public bool AllowRumble = true;

    [MMNVInspectorButton("TestVibration")] public bool TestVibrationButton;
