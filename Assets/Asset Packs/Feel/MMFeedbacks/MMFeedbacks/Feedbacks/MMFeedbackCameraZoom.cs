...
public class MMFeedbackCameraZoom : MMFeedback
{
    ...
    [Tooltip("the target field of view")] public float ZoomFieldOfView = 30f;
    ...
    {
        get { return ApplyTimeMultiplier(ZoomDuration); }
    ...
    protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
    {
        if (Active)
        {
            MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, Channel,
                                      Timing.TimescaleMode == TimescaleModes.Unscaled, false, RelativeFieldOfView);
        }
    }
    ...
    protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
    {
        ...
        {
            MMCameraZoomEvent.Trigger(ZoomMode, ZoomFieldOfView, ZoomTransitionDuration, FeedbackDuration, Channel,
                                      Timing.TimescaleMode == TimescaleModes.Unscaled, stop: true);
        }
    }
}
}