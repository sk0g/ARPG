...
[AddComponentMenu("")]
[FeedbackHelp(
    "This feedback allows you to bind any type of Unity events to this feebdack's Play, Stop, Initialization and Reset methods.")]
...
public class MMFeedbackEvents : MMFeedback
{
    ...
    protected override void CustomInitialization(GameObject owner)
    {
        ...
        if (Active && (InitializationEvents != null)) { InitializationEvents.Invoke(); }
    }
    ...
    {
        if (Active && (PlayEvents != null)) { PlayEvents.Invoke(); }
    }
    ...
    {
        if (Active && (StopEvents != null)) { StopEvents.Invoke(); }
    }
    ...
    {
        base.CustomReset();
        if (Active && (ResetEvents != null)) { ResetEvents.Invoke(); }
    }
}
}