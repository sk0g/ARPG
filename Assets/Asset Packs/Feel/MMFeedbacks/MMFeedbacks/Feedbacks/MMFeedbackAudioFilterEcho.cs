...
[FeedbackHelp(
    "This feedback lets you control an echo audio filter's wet mix value over time. You'll need a MMAudioFilterEchoShaker on your filter.")]
public class MMFeedbackAudioFilterEcho : MMFeedback
{
    ...
    [Range(0f, 1f)] [Tooltip("the value to remap the curve's 0 to")]
    public float RemapEchoZero = 0f;

    /// the value to remap the curve's 1 to
    [Range(0f, 1f)] [Tooltip("the value to remap the curve's 1 to")]
    ...
    protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
    {
        if (Active)
        {
            ...
            MMAudioFilterEchoShakeEvent.Trigger(ShakeEcho, FeedbackDuration, RemapEchoZero, RemapEchoOne, RelativeEcho,
                                                ...
                                                ResetTargetValuesAfterShake, NormalPlayDirection, Timing.TimescaleMode);
        }
    }
