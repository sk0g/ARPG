...
public class MMFeedbackFlash : MMFeedback
{
    ...
    [Tooltip("the color of the flash")] public Color FlashColor = Color.white;
    ...
    [Tooltip("the alpha of the flash")] public float FlashAlpha = 1f;
    ...
    {
        get { return ApplyTimeMultiplier(FlashDuration); }
    ...
    protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
    {
        ...
        if (Active)
        {
            MMFlashEvent.Trigger(FlashColor, FeedbackDuration, FlashAlpha, FlashID, Channel, Timing.TimescaleMode,
                                 stop: true);
        }
    }
}
