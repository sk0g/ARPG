...
public static class MMFeedbackStyling
{
    ...
    {
        get { return EditorGUIUtility.isProSkin ? _splitterdark : _splitterlight; }
    }
    ...
    {
        get { return EditorGUIUtility.isProSkin ? _headerbackgrounddark : _headerbackgroundlight; }
    }
    ...
    {
        get { return EditorGUIUtility.isProSkin ? _reorderdark : _reorderlight; }
    }
    ...
    {
        get { return EditorGUIUtility.isProSkin ? _paneoptionsicondark : _paneoptionsiconlight; }
    }
        ...
        float startedAt, float duration, float totalDuration, MMFeedbackTiming timing, bool pause, MMFeedbacks host)
    {
        ...
        if (!pause) { headerBackgroundColor = HeaderBackground; }
        else { headerBackgroundColor = feedbackColor; }
        ...
        else { timingInfo = totalDuration.ToString("F2") + "s"; }
        ...
        else { EditorGUI.DrawRect(progressRect, headerBackgroundColor); }
