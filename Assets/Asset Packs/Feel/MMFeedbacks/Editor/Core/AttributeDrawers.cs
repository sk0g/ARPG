...
public class MMFConditionAttributeDrawer : PropertyDrawer
{
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        if (!conditionAttribute.Hidden || enabled) { return EditorGUI.GetPropertyHeight(property, label); }
        else { return -EditorGUIUtility.standardVerticalSpacing; }
    }
}
...
public class MMFInformationAttributeDrawer : PropertyDrawer
{
    ...
    {
        get { return ((MMFInformationAttribute) attribute); }
    }
        ...
        if (HelpEnabled())
        {
            ...
            else
            {
                ...
                helpPosition.y += GetPropertyHeight(prop, label)
                                  - DetermineTextboxHeight(informationAttribute.Message)
    ...
    protected virtual bool HelpEnabled()
    {
        ...
        {
            if (EditorPrefs.GetBool("MMShowHelpInInspectors")) { helpEnabled = true; }
        }
