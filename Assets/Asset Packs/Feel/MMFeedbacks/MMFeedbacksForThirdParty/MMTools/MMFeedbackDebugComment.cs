...
public class MMFeedbackDebugComment : MMFeedback
{
    ...
    {
        get { return MMFeedbacksInspectorColors.DebugColor; }
    }
#endif

    /// the comment / note associated to this feedback 
    [Tooltip("the comment / note associated to this feedback")] [TextArea(10, 30)]
    ...
    [Tooltip("the color of the message when in DebugLogTime mode")] [MMCondition("LogComment", true)]
    ...
    {
        if (Active && LogComment) { Debug.Log(Comment); }
    }
}
}