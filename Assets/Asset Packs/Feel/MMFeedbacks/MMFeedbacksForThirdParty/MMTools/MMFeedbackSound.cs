...
public class MMFeedbackSound : MMFeedback
{
    ...
    [Header("Test")] [MMFInspectorButton("TestPlaySound")]
    public bool TestButton;

    [MMFInspectorButton("TestStopSound")] public bool TestStopButton;
    ...
    protected override void CustomInitialization(GameObject owner)
    {
        ...
        if (PlayMethod == PlayMethods.Pool)
        {
            ...
            for (int i = 0; i < PoolSize; i++) { _pool[i] = CreateAudioSource(owner, "PooledAudioSource" + i); }
        }
    }
    ...
    protected virtual float GetDuration()
    {
        ...
        if ((RandomSfx != null) && (RandomSfx.Length > 0))
        {
            ...
            {
                if ((clip != null) && (clip.length > longest)) { longest = clip.length; }
            }
