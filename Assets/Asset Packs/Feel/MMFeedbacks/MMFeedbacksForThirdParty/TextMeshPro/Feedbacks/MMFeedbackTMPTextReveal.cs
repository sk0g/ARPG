...
public class MMFeedbackTMPTextReveal : MMFeedback
{
    ...
    public override float FeedbackDuration
    {
        ...
        set
        {
            if (DurationMode == DurationModes.TotalDuration) { RevealDuration = value; }
            else
            {
    ...
    protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
    {
        ...
        case RevealModes.Character:
            _delay = (DurationMode == DurationModes.Interval)
                ...
                : RevealDuration / TargetTMPText.text.Length;
    ...
    protected virtual IEnumerator RevealCharacters()
    {
        ...
        while (visibleCharacters <= totalCharacters)
        {
            ...
            if (Timing.TimescaleMode == TimescaleModes.Scaled) { yield return MMFeedbacksCoroutine.WaitFor(_delay); }
            else { yield return MMFeedbacksCoroutine.WaitForUnscaled(_delay); }
        }
    }
