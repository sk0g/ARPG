...
public class MMFeedbackColorAdjustments_HDRP : MMFeedback
{
    ...
    /// the value to remap the curve's 0 to
    [Tooltip("the value to remap the curve's 0 to")] [Range(-180f, 180f)]
    ...
    public MMColorAdjustmentsShaker_HDRP.ColorFilterModes ColorFilterMode =
        MMColorAdjustmentsShaker_HDRP.ColorFilterModes.None;
    ...
    protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
    {
        if (Active)
        {
            ...
            MMColorAdjustmentsShakeEvent_HDRP.Trigger(ShakePostExposure, RemapPostExposureZero, RemapPostExposureOne,
                                                      ...
                                                      ColorFilterMode, ColorFilterGradient, ColorFilterDestination,
                                                      ColorFilterCurve,
                                                      FeedbackDuration,
                                                      RelativeIntensity, intensityMultiplier, Channel,
                                                      ResetShakerValuesAfterShake, ResetTargetValuesAfterShake,
