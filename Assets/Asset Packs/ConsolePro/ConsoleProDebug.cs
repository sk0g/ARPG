...
public static class ConsoleProDebug
{
    ...
    {
#if UNITY_EDITOR
        if (ConsoleClearMethod != null) { ConsoleClearMethod.Invoke(null, null); }
#endif
    }
    ...
    private static MethodInfo ConsoleClearMethod
    {
        get
        {
            if (_consoleClearMethod == null || !_checkedConsoleClearMethod)
            {
                ...
                _consoleClearMethod =
                    ConsoleWindowType.GetMethod("ClearEntries", BindingFlags.Static | BindingFlags.Public);
            }
        ...
        get
        {
            if (_consoleWindowType == null || !_checkedConsoleWindowType)
            {
                ...
                for (int iAssembly = 0; iAssembly < assemblies.Length; iAssembly++)
                {
                    ...
                    {
                        if (types[iType].Name == "ConsolePro3Window") { _consoleWindowType = types[iType]; }
                    }
                }
            }
