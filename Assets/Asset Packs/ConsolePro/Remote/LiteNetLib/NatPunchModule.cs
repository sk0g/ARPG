...
public sealed class NatPunchModule
{
    ...
    private void HandleNatPunch(NetEndPoint senderEndPoint, NetDataReader dr)
    {
        ...
        NetUtils.DebugWrite(ConsoleColor.Green, "[NAT] punch received from {0} - additional info: {1}", senderEndPoint,
                            additionalInfo);
    ...
    private void HandleNatIntroduction(NetDataReader dr)
    {
        ...
        NetUtils.DebugWrite(ConsoleColor.Cyan,
                            "[NAT] introduction received; we are designated "
                            + (hostByte == HostByte ? "host" : "client"));
