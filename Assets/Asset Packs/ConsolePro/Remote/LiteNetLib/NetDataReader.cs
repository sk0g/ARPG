...
public class NetDataReader
{
    ...
    public bool[] GetBoolArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetBool(); }
    ...
    public ushort[] GetUShortArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetUShort(); }
    ...
    public short[] GetShortArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetShort(); }
    ...
    public long[] GetLongArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetLong(); }
    ...
    public ulong[] GetULongArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetULong(); }
    ...
    public int[] GetIntArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetInt(); }
    ...
    public uint[] GetUIntArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetUInt(); }
    ...
    public float[] GetFloatArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetFloat(); }
    ...
    public double[] GetDoubleArray()
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetDouble(); }
    ...
    public string[] GetStringArray(int maxLength)
    {
        ...
        for (int i = 0; i < size; i++) { arr[i] = GetString(maxLength); }
